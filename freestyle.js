$(document).ready(function() {
  ...
  "using plane imagery", "acting drunk", "acting high", "acting like a dragon", "acting like a spider", "acting like a monkey",
  ...
  "pretending to eat a hotdog", "pretending to play basketball", "pretending to play baseball"]
  ...
  textures = ["being sharp", "being quick", "being slow", "being milky", "being sexy", "being smooth", "using wordplay",
  "using grooves", "expressing anger", "expressing sadness", "expressing happiness", "expressing fatigue", "not moving your elbows",
  ...
  "telling a popular bedtime story", "telling a heartbreak story", "telling a movie plot", "bouncing the entire time"]
